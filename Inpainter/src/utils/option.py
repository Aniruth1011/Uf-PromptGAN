...
# data specifications 
parser.add_argument('--dir_image', type=str, default='../data/image',
                    help='image dataset directory')
parser.add_argument('--dir_mask', type=str, default = '../data/mask',
                    help='mask dataset directory')
parser.add_argument('--data_train', type=str, default='flareremovaltrainwithprompts',
                    help='dataname used for training')
parser.add_argument('--data_test', type=str, default='flareremovaltest2',
...
parser.add_argument('--tensorboard', action='store_true',
                    help='default: True, since it will slow training. use it for debugging')

# test and demo specifications 
parser.add_argument('--pre_train', type=str, default='../experiments/aotgan_flareremovaltrain_pconv256/O0012000.pt',
                    help='path to pretrained models')
parser.add_argument('--outputs', type=str, default='/home/santhi/MIPI_Promptir/MIPI/Submission/Pretrained_levin', 
